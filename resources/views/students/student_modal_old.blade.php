...
<div class="modal fade" id="studentEditModal" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          ...
          <button type="button" class="close"  ng-click="hide_data_modal('studentEditModal')">
          <i class="icons icon-close"></i></button>
        </div>
        <form name="StudentEditForm" ng-submit="update_data(StudentEditForm.$valid)" novalidate="novalidate">
          <div class="modal-body">
            <div class="row">

              <div class="col-md-3 form-group">
                <label class="label-control">Name</label>
                <input type="text" class="form-control" ng-model="personal_details.student.name" required>
              </div>

              <div class="col-md-3 form-group">
                <label class="label-control">DOB</label>
                <input type="text" class="datepicker form-control" ng-model="personal_details.student.dob" required>
              </div>

              <div class="col-md-3 form-group">
                <label class="label-control">Father Name</label>
                <input type="text" class="form-control" ng-model="personal_details.student.father" required>
              </div>

              <div class="col-md-3 form-group">
                <label class="label-control">Mother Name</label>
                <input type="text" class="form-control" ng-model="personal_details.student.mother" required>
              </div>

              <div class="col-sm-3 form-group">
                <label>City</label>
                <select class="form-control" ng-model="personal_details.student.city_id" required>
              ...
              <div class="col-sm-3 form-group">
                <label>Center</label>
                <select class="form-control" ng-model="personal_details.student.center_id" required>
                  <option value="0">Select</option>
                  <option ng-repeat="center in state_city_center.center" 
                  ng-value="@{{center.id}}"  ng-if="center.city_id == personal_details.student.city_id">@{{center.center_name}}
                  </option>
                </select>
              </div>
              ...
              <div class="col-sm-3 form-group">
                <label>Group</label>
                <select class="form-control" ng-model="personal_details.student.group_id" required>
                  <option value="0">Select</option>
                  <option ng-repeat="group in state_city_center.group" 
                  ng-value="@{{group.id}}"  ng-if="group.center_id ==  personal_details.student.center_id">@{{group.group_name}}
                  </option>
                </select>
              </div>
              ...
              <div class="col-sm-3 form-group">
                <label>School</label>
                <input type="text" class="form-control" ng-model="personal_details.student.school" required>
                </select>
              </div>
            </div>
          </div>
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-secondary" 
            ng-click="hide_data_modal('studentEditModal')">Close</button>
          </div>
        </form>
