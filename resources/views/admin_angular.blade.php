...
<script type="text/javascript" src="{{url('assets/plugins/admin/scripts/core/students/user_controller.js?v='.env('JS_VERSION'))}}" ></script>
...
<script type="text/javascript" src="{{url('assets/plugins/admin/scripts/core/students/roles_controller.js?v='.env('JS_VERSION'))}}" ></script>
<script type="text/javascript" src="{{url('assets/plugins/admin/scripts/core/students/staff_attendance_controller.js?v='.env('JS_VERSION'))}}" ></script>
