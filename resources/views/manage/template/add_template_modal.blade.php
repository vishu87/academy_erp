                        ...
                        <form ng-submit="onSubmit(addForm.$valid)" name="addForm" novalidate>
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    <label>Template For <span class="error">*</span></label><br>
