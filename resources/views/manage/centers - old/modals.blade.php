    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Add/Update Group</h4>
                <button type="button" class="close" ng-click="hideModal('group_modal');">&times;</button>
            </div>
            <div class="modal-body">
                ...
                <div class="form-group" ng-show="group.group_type_id != 1">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" ng-click="onSubmit_group(group)">Submit</button>
                <button type="button" class="btn btn-light" ng-click="hideModal('group_modal');">Close</button>
...
<div class="modal" id="training_day_modal" role="dialog" style="overflow: scroll;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Add/Update Training Day</h4>
                <button type="button" class="close" ng-click="hideModal('training_day_modal');">&times;</button>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" ng-click="addTimingInList()" ladda="timing.processing">@{{timing.update==true ? 'Update':'Add To List'}}</button>

                <button type="button" class="btn btn-light" ng-click="hideModal('training_day_modal');">Close</button>
                <!-- <button type="button" class="btn btn-danger" ng-click="cancelTimingEdit()">Cancel</button> -->
            </div>
      </div>
    </div>
</div>
